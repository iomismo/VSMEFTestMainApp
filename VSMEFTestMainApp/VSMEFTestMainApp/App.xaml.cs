...
namespace VSMEFTestMainApp
{
    ...
    public partial class App : Application
    {
        ...
        {
            AppDomain.CurrentDomain.AssemblyResolve += PriResourceResolver.AssemblyResolveHandler;
    ...
    static class PriResourceResolver
    {
        ...
        internal static Assembly AssemblyResolveHandler(object sender, ResolveEventArgs args)
        {
            ...
            try
            {
                ...
                //NamedResource desiredResource = fileResources.ContainsKey(targetFileName) ? fileResources[targetFileName] : null;
                ...
                if (!args.Name.StartsWith("VSMEF"))
                {
                    return Assembly.UnsafeLoadFrom(absoluteFileName);
                }
